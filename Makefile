...
PYTHON_FIND=find simcityexplore scripts tests -name '*.py'
...
test: test-requirements pyflakes pep8 unittest

unittest-coverage:
	@echo "======= Unit Tests ========="
	@nosetests --with-coverage --cover-package=simcityexplore
